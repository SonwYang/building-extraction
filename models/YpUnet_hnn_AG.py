...
class UNet(nn.Module):
    ...
    def __init__(self, num_classes=1,  pretrained=True, use_batchnorm=True, freeze_encoder=False):
        ...
        #     # Assign new conv layer with 3 input channels
        ...
        #attention gates
        self.attention2 = Attention_block(num_classes, num_classes, num_classes)
        self.attention3 = Attention_block(num_classes, num_classes, num_classes)
        self.attention4 = Attention_block(num_classes, num_classes, num_classes)
    ...
    def forward(self, x):
        ...
        conv1 = self.pool(conv0)         #[64, 256, 256]
        conv1 = self.conv1(conv1)        #[256, 128, 128]
        conv2 = self.conv2(conv1)        #[512, 64, 64]
        conv3 = self.conv3(conv2)        #[1024, 32, 32]
        conv4 = self.conv4(conv3)        #[2048, 16, 16]
        ...
        dsv4 = self.dsv4(F.upsample_bilinear(x4, size=SIZE))

        #attention gates
        dsv2 = self.attention2(dsv1, dsv2)
        dsv3 = self.attention3(dsv2, dsv3)
        dsv4 = self.attention4(dsv3, dsv4)
