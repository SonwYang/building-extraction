...
if __name__ =="__main__":
    ...
    parse.add_argument("--model_name", type=str, default="HA-Unet", help='myUnet, HA-Unet, AlbuNet, FPN, UNet , PSPNet')
    ...
    parse.add_argument("--ckp", type=str, default="", help='the path of model weight file')
